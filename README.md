...
## 👨‍💻 About Me
Hi, I’m **Shubham Prajapati**, a Data Analyst focused on SQL, Python, Excel, and Power BI. I enjoy cleaning messy data, finding the story behind business metrics, and presenting insights in a way that supports confident decisions.

This project is part of my Data Analyst portfolio and reflects the way I approach a real analytics assignment: understand the business question, prepare reliable data, analyze performance, and communicate recommendations clearly.


## 💡 Thanks for checking out my project
This repository is a practical example of my data analytics skills and problem-solving approach. Feel free to explore the notebook, SQL queries, dashboard, and supporting reports.
